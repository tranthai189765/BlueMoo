...
public class AdminListUserController {
    ...
    public ResponseEntity<?> deactivateUser(@PathVariable Long id) {
        ...
        return deactivated ? ResponseEntity.ok("User deactivated successfully") : ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("Failed to deactivate user");
    }
    ...
    public ResponseEntity<?> activateUser(@PathVariable Long id) {
        ...
        if (!activated) {
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("Failed to activate user");
        }
        User user = userService.findById(id);
        Resident resident = residentService.findById(user.getResidentId());
